...
/**
 * Formats NCES grade codes without treating zero (kindergarten) as missing.
 * Negative source values may mean unavailable, suppressed, or not applicable.
 */
...
/** Maps sector-specific NCES level codes to display labels. */
...
/** Maps public/private school type codes using their distinct source schemas. */
...
/** Preserves legitimate zero counts while hiding negative source sentinels. */
